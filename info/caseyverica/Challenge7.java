...
public class Challenge7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Acct1 balance = " + account1.getBalance());
        System.out.println("Acct2 balance = " + account2.getBalance());
...
class NewBankAccount {
    ...
    public synchronized boolean transfer(NewBankAccount destinationAccount, double amount) {
        if (withdraw(amount)) {
